...
const post = async (url: string, object: Object) => {
  try {
...
const put = async (url: string, object: Object) => {
  try {
...
//
const patch = async (url: string, object: Object) => {
  try {
...
const del = async (url: string, object: Object) => {
  try {
